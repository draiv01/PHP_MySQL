...
$jobexp = [
    [
        'job' => 'Курьер',
        'data' => 'Январь 2015 - Март 2016',
        'deck' => 'развозка',
    ],
    [
        'job' => 'Логист',
        'data' => 'Апрель 2017 - Март 2018',
        'deck' => 'работа в 1С',
    ],
    [
        'job' => 'Водитель',
        'data' => 'Июнь 2019 - Сентябрь 2022',
        'deck' => 'развозка',
    ],
        [
        'job' => 'Слесарь',
        'data' => 'Сентябрь 2022 - по настоящее время',
        'deck' => 'второй разряд',
    ],
];
?>
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
            ...
            <div class="w3-container">
                    <h5 class="w3-opacity"><b><?php echo $jobexp[$i]['job'];?></b></h5>
                        <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $jobexp[$i]['data'];?></h6>
                            <p><?php echo $jobexp[$i]['deck'];?></p>
            <hr>
            </div>
            </div>
            <?php endfor;?>
